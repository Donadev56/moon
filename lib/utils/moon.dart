...
class MoonContractManager {
  ...
  Future<Map<String, dynamic>> getHistories(addr) async {
    try {
      final resultPromise = GetUserHistories(addr);
      final resultDart = await resultPromise.toDart;
      final converted = dartify(resultDart);
  ...
  Future<Map<String, dynamic>> getWithdrawals(addr) async {
    try {
      final resultPromise = GetUserWithdraw(addr);
      final resultDart = await resultPromise.toDart;
      final converted = dartify(resultDart);
